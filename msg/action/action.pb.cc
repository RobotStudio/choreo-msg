...
namespace protobuf_action_2faction_2eproto {
...
void protobuf_AssignDescriptors() {
  ...
  AssignDescriptors(
      "action/action.proto", schemas, file_default_instances, TableStruct::offsets, factory,
...
void AddDescriptorsImpl() {
  ...
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "action/action.proto", &protobuf_RegisterTypes);
...
const ::google::protobuf::EnumDescriptor* GoalStatus_GoalStatusType_descriptor() {
  protobuf_action_2faction_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_action_2faction_2eproto::file_level_enum_descriptors[0];
}
...
GoalID::GoalID()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    protobuf_action_2faction_2eproto::InitDefaults();
  }
  SharedCtor();
...
const ::google::protobuf::Descriptor* GoalID::descriptor() {
  protobuf_action_2faction_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_action_2faction_2eproto::file_level_metadata[kIndexInFileMessages].descriptor;
}
...
::google::protobuf::Metadata GoalID::GetMetadata() const {
  protobuf_action_2faction_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_action_2faction_2eproto::file_level_metadata[kIndexInFileMessages];
}
